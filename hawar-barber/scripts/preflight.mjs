...
const toml = readFileSync('wrangler.toml', 'utf8') + readFileSync('wrangler.workers.toml', 'utf8');
if (toml.includes('00000000-0000-0000-0000-000000000000')) {
  console.error('wrangler.toml / wrangler.workers.toml still have the placeholder database_id.\nRun: npx wrangler d1 create hawar-barber-bookings   and paste the id it prints, then deploy again.');
  process.exit(1);
}
