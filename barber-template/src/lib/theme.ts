...
export const THEMES: readonly Theme[] = [
  ...
  },
  {
    ...
    ticker: false,
    numerals: false,
    display: { width: 0.46, maxVw: 22, maxRem: 6.5, budgetPx: 600 },
    scheme: 'light',
    themeColor: '#f7f4ee',
  ...
  },
  {
    ...
    ticker: true,
    numerals: true,
    display: { width: 0.72, maxVw: 15, maxRem: 5.5, budgetPx: 880 },
    scheme: 'light',
    themeColor: '#eadcc4',
    og: { ground: '#35251b', text: '#f6ece0', muted: '#c3a98d', accent: '#d9705c', display: 'Big Shoulders Display', upper: true, width: 0.46 },
  },
  {
    id: 'steel',
    hero: 'split',
    services: 'cards',
    order: ['reviews', 'gallery', 'prices', 'about', 'find-us'],
    ticker: true,
    numerals: true,
    display: { width: 0.64, maxVw: 16, maxRem: 5.5, budgetPx: 600 },
    scheme: 'light',
    themeColor: '#f4f6f8',
