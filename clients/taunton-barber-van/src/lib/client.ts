...
export interface Photo { src: string; alt: string; position?: string; caption?: string }
...
export interface Client {
  ...
  base: { street: string; locality: string; postcode: string; country: string };
  rating: { value: number; count: number; url: string };
  hours: Hours[];
  hero: Photo & { label: string; line: string; cta: string };
  van: { label: string; heading: string; accent: string; paragraphs: string[] };
  how: { label: string; heading: string; accent: string; steps: Step[] };
  families: { label: string; heading: string; accent: string; paragraphs: string[]; quote: { text: string; author: string }; photos: Photo[] };
  services: { label: string; heading: string; accent: string; pricingLabel: string; pricingNote: string; items: Service[] };
  work: { label: string; heading: string; accent: string; photos: Photo[] };
  reviews: { label: string; heading: string; accent: string; intro: string; linkText: string; items: Review[] };
  book: { label: string; heading: string; accent: string; body: string; baseNote: string; whatsapp: string; call: string };
...
export function photo(name: string): ImageMetadata {
  ...
  if (!hit) throw new Error(`Photo "${name}" not found in clients/taunton-barber-van/photos/`);
  return hit;
}
